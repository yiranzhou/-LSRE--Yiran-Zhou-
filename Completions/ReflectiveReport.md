...
|System user management|The system should be able to manage the users.|WHY: The user want to manage the users who have restriction to use this system. BENEFIT:The user can manage the users who use the system.||
