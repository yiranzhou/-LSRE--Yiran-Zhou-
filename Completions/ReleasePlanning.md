...
The issue trachker is easy to use. It provides relatively complete version control tool, such as milestone. And the team mates could discuss the proposed requirements. By the way, I think the issue tracker is more useful for a team rather than the individual.   
